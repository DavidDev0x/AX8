...
module adder_subtractor_tb;
  ...
  initial begin
    ...
    check(8'hFF, 8'hFF, 0, 0, 8'hFE, 1);  // ADD: 0xFF + 0xFF + C=0 -> 0xFE, C=1

    check(8'hB4, 8'h3C, 1, 1, 8'h78, 1);  // SUB: 0xB4 - 0x3C - (~C=1) -> 0x78, C=1
    check(8'h2A, 8'h2A, 1, 1, 8'h00, 1);  // SUB: 0x2A - 0x2A - (~C=1) -> 0x00, C=1
    check(8'h32, 8'h78, 0, 1, 8'hB9, 0);  // SUB: 0x32 - 0x78 - (~C=0) -> 0xB9, C=0
